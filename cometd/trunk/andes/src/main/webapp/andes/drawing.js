...
(function(){
	...
	dojo.addOnLoad(function(){
		var whiteboard = {
			...
			subscribe: function() {
				...
				cometd.subscribe("/whiteboard/" + getUrlVars()["p"] + getUrlVars()["s"], this, "receive");
			}
		};
	...
	// Need to submit to SVN. Use this after talk with Brett on server serving flags.
	/*if(whiteboardEnabled){
		dojo.mixin(andes.drawing,andes.drawingWhiteboard);
	}*/
	...
	andes.drawing = {
		...
		add: function(/* Stencil */ item, /*Boolean*/ saveToServer, /*Boolean*/noConnect){
			...
			item.connect("onDelete", this, function(item){
				...
				if(publish_flag) {
				cometd.publish("/whiteboard/" + getUrlVars()["p"] + getUrlVars()["s"], {
					user: getUrlVars() ["u"],
