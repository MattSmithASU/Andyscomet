...
if (!dojo._hasResource["dojox.atom.widget.FeedEntryEditor"]) {
	...
	dojo.requireLocalization("dojox.atom.widget", "FeedEntryEditor", null, "ROOT,ar,az,ca,cs,da,de,el,es,fi,fr,he,hu,it,ja,kk,ko,nb,nl,pl,pt,pt-pt,ro,ru,sk,sl,sv,th,tr,zh,zh-tw");
	dojo.requireLocalization("dojox.atom.widget", "PeopleEditor", null, "ROOT,ar,az,ca,cs,da,de,el,es,fi,fr,he,hu,it,ja,kk,ko,nb,nl,pl,pt,pt-pt,ro,ru,sk,sl,sv,th,tr,zh,zh-tw");
