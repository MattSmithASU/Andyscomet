...
if (!dojo._hasResource["dojox.grid.enhanced.plugins.Search"]) {
	...
	dojo.declare("dojox.grid.enhanced.plugins.Search", dojox.grid.enhanced._Plugin, {name:"search", constructor:function (grid, args) {
		...
		var _this = this, cnt = this._cacheSize, args = {"start":start, "onBegin":function (size) {
		...
		var g = this.grid, s = g.store, i, field, cells = dojo.filter(g.layout.cells, function (cell) {
			return !cell.hidden;
		});
		if (isGlobal) {
