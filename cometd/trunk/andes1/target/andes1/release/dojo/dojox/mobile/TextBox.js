...
if (!dojo._hasResource["dojox.mobile.TextBox"]) {
	dojo._hasResource["dojox.mobile.TextBox"] = true;
	dojo.provide("dojox.mobile.TextBox");
	dojo.require("dijit._WidgetBase");
	dojo.require("dijit.form._FormWidgetMixin");
	dojo.require("dijit.form._TextBoxMixin");
	dojo.declare("dojox.mobile.TextBox", [dijit._WidgetBase, dijit.form._FormValueMixin, dijit.form._TextBoxMixin], {baseClass:"mblTextBox", _setPlaceHolderAttr:"textbox", buildRendering:function () {
		if (!this.srcNodeRef) {
