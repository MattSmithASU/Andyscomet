...
if (!dojo._hasResource["dojox.mobile.SpinWheelDatePicker"]) {
	dojo._hasResource["dojox.mobile.SpinWheelDatePicker"] = true;
	dojo.provide("dojox.mobile.SpinWheelDatePicker");
	dojo.require("dojo.date");
	dojo.require("dojo.date.locale");
	dojo.require("dojox.mobile.SpinWheel");
	dojo.declare("dojox.mobile.SpinWheelDatePicker", dojox.mobile.SpinWheel, {slotClasses:["dojox.mobile.SpinWheelYearSlot", "dojox.mobile.SpinWheelMonthSlot", "dojox.mobile.SpinWheelDaySlot"], slotProps:[{labelFrom:1900, labelTo:2100}, {}, {labelFrom:1, labelTo:31}], buildRendering:function () {
	...
	dojo.declare("dojox.mobile.SpinWheelYearSlot", dojox.mobile.SpinWheelSlot, {buildRendering:function () {
		this.labels = [];
	...
	dojo.declare("dojox.mobile.SpinWheelMonthSlot", dojox.mobile.SpinWheelSlot, {buildRendering:function () {
		this.labels = [];
	...
	dojo.declare("dojox.mobile.SpinWheelDaySlot", dojox.mobile.SpinWheelSlot, {});
}
